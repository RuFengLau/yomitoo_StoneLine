        ...
        return (
                        ...
                        this.instance
                            ...
                            .catch(function (e) {
                                t.girdCallback && t.girdCallback(!1),
                                    ...
                                    gm.err("OppoGirdAd err :" + JSON.stringify(e));
                            });
            }),
            (e.prototype.onClose = function () {
                (this.state = r.AdState.close),
                    gm.log(" OppoGirdAd onClose"),
                    this.girdCallback && this.girdCallback(!0),
                    (this.girdCallback = null),
                    this.load();
            }),
            ...
            (e.prototype.create = function (t) {
                qg.getSystemInfoSync().platformVersionCode < 1076
                    ...
                    : (gm.info("OppoGirdAd adID: " + t),
                      this.instance ||
                          ((this.instance = qg.createGamePortalAd({adUnitId: t})),
                          this.instance.onLoad(this.onLoad.bind(this)),
                          this.instance.onError(this.onError.bind(this)),
                          this.instance.onClose(this.onClose.bind(this))));
            }),
            (e.prototype.onError = function (t) {
                gm.err("OppoGirdAd onError", JSON.stringify(t)),
                    (this.loadState = r.AdLoadState.loadFail),
                    this.reLoad();
            }),
            (e.prototype.onLoad = function () {
                gm.info("OppoGirdAd onLoad"), (this.loadState = r.AdLoadState.loadSucess);
            }),
            e
        );
    })(a.GridAdBase);
