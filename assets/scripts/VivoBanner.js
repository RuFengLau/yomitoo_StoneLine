        ...
        return (
            ...
            (e.prototype.reLoad = function () {
                ...
                this.bannerMode == a.AdShowModeType.Mix &&
                    ...
                    (console.log("vivo reLoad"), this.nativeBanner.open());
            }),
                ...
                (this.state = s.AdState.open),
                    this.instance &&
                        this.instance
                            ...
                            .then(function () {})
                            .catch(function (t) {
                                gm.err("VivoBanner err :" + JSON.stringify(t));
                            });
            }),
            ...
            (e.prototype.create = function (t) {
                gm.info("VivoBanner adID: " + t),
                    this.destroy(),
                    this.instance ||
                        ((this.instance = qg.createBannerAd({posId: t, adIntervals: 30})),
