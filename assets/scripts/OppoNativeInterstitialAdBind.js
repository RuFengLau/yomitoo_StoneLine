    ...
    l = (function (t) {
        ...
        return (
            ...
            (e.prototype.flushData = function (t) {
                var e = this;
                (this.nativeInterstitialAd = t), gm.log(" OppoNativeBannerBind flushData");
                var n = this.nativeInterstitialAd.nativeAd,
                    i = n.nativeAdData;
            ...
            (e.prototype.adClick = function () {
                this.nativeInterstitialAd.nativeAd.reportAdClick();
            }),
            (e.prototype.closeBtnClick = function () {
                this.nativeInterstitialAd.close();
            }),
