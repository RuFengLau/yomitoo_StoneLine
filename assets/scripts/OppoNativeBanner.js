...
var a = t("NativeAdBase"),
    r = t("State"),
    s = t("GmBundleManager"),
    c = t("OppoNativeBannerBind"),
    l = (function (t) {
        function e() {
            var e = t.call(this) || this;
            return (e.nativeAd = null), (e.nativeAdNode = null), (e.oppoNativeBannerBind = null), e.initTimer(), e;
        }
        return (
            __extends(e, t),
            ...
            (e.prototype.isAdReady = function () {
                return !(!this.nativeAd || !this.nativeAd.isAdReady());
            }),
            ...
            (e.prototype.create = function (t) {
                ...
                gm.log("OppoNativeBanner create id" + t),
                    s.default.inst.loadRes("GmRes", "Oppo/NativeBanner/nativeBanner", cc.Prefab, function (t) {
