...
var a = t("NativeAdBase"),
    ...
    l = (function (t) {
        function e(e) {
            ...
            return (
                (n.nativeAdNode = null),
                (n.nativeAdBgNode = null),
                (n.nativeAdInstance = null),
                (n.timerLoopLoadCallFunc = null),
                n.create(n.adUnitID),
                n
            );
        }
        return (
            ...
            (e.prototype.open = function (t) {
                this.isAdReady() && ((this.nativeAdBgNode = t), this.show());
            }),
            ...
            (e.prototype.close = function () {
                (this.state = r.AdState.close), this.nativeAdNode && (this.nativeAdNode.active = !1), this.load();
            }),
            ...
            (e.prototype.load = function () {
                this.loadState != r.AdLoadState.loading &&
                    (gm.log(" OppoNativeAd load"),
                    (this.loadState = r.AdLoadState.loading),
                    this.nativeAdInstance.load());
            }),
            ...
            (e.prototype.onError = function (t) {
                (this.loadState = r.AdLoadState.loadFail),
                    gm.err(" OppoNativeAd onError err : ", JSON.stringify(t)),
                    this.reLoad();
            }),
            (e.prototype.onLoad = function (t) {
                this.loadState = r.AdLoadState.loadSucess;
                var e = t.adList;
                if ((gm.info("OppoNativeAd onLoad ", JSON.stringify(e)), e.length <= 0))
                    return (
                        gm.err(" OppoNativeAd error adList length : ", e.length),
                        (this.loadState = r.AdLoadState.loadFail),
                        void this.reLoad()
                    );
            ...
            (e.prototype.reportAdClick = function () {
                this.nativeAdInstance &&
                    (gm.log("OppoNativeAd reportAdClick ", this.nativeAdData.adId),
                    this.nativeAdInstance.reportAdClick({adId: this.nativeAdData.adId}));
            }),
            (e.prototype.reportAdShow = function () {
                this.nativeAdInstance &&
                    (gm.log("OppoNativeAd reportAdShow ", this.nativeAdData.adId),
                    this.nativeAdInstance.reportAdShow({adId: this.nativeAdData.adId}));
            }),
            (e.prototype.destroy = function () {
                (this.nativeAdData = null),
                    this.nativeAdInstance &&
                        (this.nativeAdInstance.offLoad(this.onLoad.bind(this)),
                        this.nativeAdInstance.offError(this.onError.bind(this)),
                        this.nativeAdInstance.destroy(),
                        (this.nativeAdInstance = null));
            }),
            (e.prototype.create = function (t) {
                var e = this;
                this.loadState != r.AdLoadState.loading &&
                    (this.destroy(),
                    gm.log("OppoNativeAd create : " + t),
                    (this.nativeAdInstance = qg.createNativeAd({adUnitId: t})),
                    this.nativeAdInstance.onLoad(this.onLoad.bind(this)),
                    this.nativeAdInstance.onError(this.onError.bind(this)),
                    this.load(),
                    s.default.inst.loadRes("GmRes", "Oppo/NativeAd/nativeAd", cc.Prefab, function (t) {
